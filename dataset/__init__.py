...
from dataset.caption_dataset import coco_dataset

from dataset.randaugment import RandomAugment

# 설명 : 데이터셋에 대한 정보를 받아서 transform을 적용한 후, DataLoader를 생성하여 반환합니다.
...
# 설명 : 데이터 로더에서 배치 단위로 데이터를 불러올 때, 데이터를 어떻게 묶을지에 대한 함수입니다.
